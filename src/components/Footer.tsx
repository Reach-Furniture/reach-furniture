          ...
          <div>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                <img src={emailIcon} alt="Email icom for REACH Furniture Studio" className="w-8" />
              ...
              >
                <img src={whatsappIcon} alt="Whatsapp icon for REACH Furniture Studio" className="w-8" />
                <span className="text-gray-300 text-lg">
                  +91 84592 78496
                </span>
              </a>
              ...
              >
                <img src={contactIcon} alt="Contact icon form for REACH Furniture Studio" className="w-7" />
                <span className="text-gray-300 text-lg">
                  Write to Us
                </span>
              </a>
