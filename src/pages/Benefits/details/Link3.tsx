    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Share the 3D Digital Products of furniture with team members, customers, suppliers and partners, as required, easily and fast to arrive at decisions faster.
          </p>
